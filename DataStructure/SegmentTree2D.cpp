...
int N;
void modifyY(int index, int l, int r, int val, int yPos, int xIndex, bool xIsLeaf) {
    if (l == r) {
        if (xIsLeaf) {
...
void queryY(int index, int l, int r, int yql, int yqr, int xIndex, int& vmax, int &vmin) {
    if (yql <= l && r <= yqr) {
